...
{
    struct addrinfo hints; /* La structure addrinfo contient un pointeur sur une struct addrinfo */
    ...
    hints.ai_socktype = SOCK_DGRAM; /* Permet d'ouvrir une socket UDP +++ATTENTION+++ changer en SOCK_STREAM pour une socket TCP */
